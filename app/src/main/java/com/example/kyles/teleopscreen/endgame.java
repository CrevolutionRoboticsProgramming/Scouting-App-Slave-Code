 ...
 */
public class endgame extends android.support.v4.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        radioGroup = v.findViewById(R.id.teleopRadioGroup);

        Button nextButton = (Button) v.findViewById(R.id.summaryNextButton);
        nextButton.setOnClickListener(this);
        return v;
    }

    public void sendData() {
        Intent toSummary = new Intent(getActivity(), SummaryScreen.class);
